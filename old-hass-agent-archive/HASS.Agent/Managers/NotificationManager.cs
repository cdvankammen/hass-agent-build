...
namespace HASS.Agent.Managers
{
    internal static class NotificationManager
    {
        ...
        private static HASS.Agent.Platform.INotifier? _platformNotifier = null;
        ...
        internal static void Initialize()
        {
            try
            {
                ...
                {
                    _platformNotifier = HASS.Agent.Platform.PlatformFactory.GetNotifier();
                }
        ...
        internal static async void ShowNotification(Notification notification)
        {
            try
            {
                ...
                {
                    // non-windows: use platform notifier
                    _platformNotifier?.Notify(notification.Title, notification.Message);
                }
            }
            catch (Exception ex)
            {
