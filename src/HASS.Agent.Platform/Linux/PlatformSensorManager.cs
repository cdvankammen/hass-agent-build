...
namespace HASS.Agent.Platform.Linux
{
    public class PlatformSensorManager
    {
        ...
        public PlatformSensorManager(IMqttManager mqtt, string deviceName = "hass-agent", int updateIntervalSeconds = 30)
        {
            ...
            // Initialize cross-platform sensors
        ...
        private void InitializeMacOSSensors()
        {
            _sensors.Add(new macOS.Sensors.MacOSSystemResourcesSensor());
            _sensors.Add(new macOS.Sensors.MacOSBatterySensor());
            _sensors.Add(new macOS.Sensors.MacOSDisplaySensor());
            _sensors.Add(new macOS.Sensors.MacOSActiveAppSensor());
            _sensors.Add(new macOS.Sensors.MacOSBrightnessSensor());
        }
